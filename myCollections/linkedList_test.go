...
func TestGetValueLinkedList(t *testing.T) {
	ml := NewLinkedList(777)
	var want int64 = 777
	got, _ := ml.GetValue(0)
	if want != got {
...
func TestRemoveByValueLinkedList(t *testing.T) {
	ml := NewLinkedList(777)
	ml.Append(1)
	ml.Append(2)
	ml.Append(3)
...
func TestRemoveByIndexLinkedList(t *testing.T) {
	ml := NewLinkedList(777)
	ml.Append(1)
	ml.Append(2)
	ml.Append(3)
...
func TestSizeLinkedList(t *testing.T) {
	ml := NewLinkedList(777)
	ml.Append(1)
	ml.Append(2)
	ml.Append(3)
